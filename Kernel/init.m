...
resolvePlotTheme["AcademicFrame2D",_]:=Themes`SetWeight[{ImageSize->500,Background->White,LabelStyle->Directive[Background->White,FontFamily->"CMU Serif",FontSize->22,Black],BaseStyle->Directive[FontSize->22,FontFamily->"CMU Serif",InsetBoxOptions->Directive[Background->White]],AxesStyle->Directive[AbsoluteThickness[1],monoColor,FontSize->24,FontFamily->"CMU Serif"],FrameStyle->Directive[AbsoluteThickness[1],monoColor,FontSize->24,FontFamily->"CMU Serif"],TicksStyle->Directive[monoColor,FontSize->22,FontFamily->"CMU Serif"],FrameTicksStyle->Directive[monoColor,FontSize->22,FontFamily->"CMU Serif"],GridLinesStyle->Directive[AbsoluteThickness[0.5],Opacity[0.5]]},$ComponentWeight];
resolvePlotTheme["AcademicFrame3D",_]:=Themes`SetWeight[{ImageSize->500,Background->White,LabelStyle->Directive[Background->White,FontFamily->"CMU Serif",FontSize->22,Black],BaseStyle->Directive[FontSize->22,FontFamily->"CMU Serif",InsetBoxOptions->Directive[Background->White]],AxesStyle->Directive[AbsoluteThickness[1],monoColor,FontSize->24,FontFamily->"CMU Serif"],TicksStyle->Directive[monoColor,FontSize->22,FontFamily->"CMU Serif"],BoxStyle->monoColor},$ComponentWeight];
